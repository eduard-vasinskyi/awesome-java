...
- [ActiveJ HTTP](https://activej.io/http) - Asynchronous HTTP client with WebSocket support.
...
- [ActiveJ RPC](https://rpc.activej.io) - Lightweight and fast library for complex high-load distributed applications and Memcached-like solutions.
...
- [ActiveJ Eventloop](https://activej.io/async-io/eventloop) - Asynchronous code executor on top of Java NIO.
...
- [ActiveJ](https://activej.io) - Modern Java platform designed to be self-sufficient (no third-party dependencies), simple, lightweight and provide competitive performance.
